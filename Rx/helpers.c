...
void printIP(char *prefix, struct sk_buff *skb, struct iphdr *ipHdr)
{
    ...
    printk(KERN_INFO "%s outer packet info: iFace:%s, sIp: %s, dIp: %s, proto: %u; tot_len=%d\n", prefix,
...
void printTCP(char *prefix, struct sk_buff *skb, struct iphdr *ipHdr)
{
    ...
    printk(KERN_INFO "%s packet info: iFace:%s, sIp: %s, sPort: %u; dIp: %s, dPort: %u; proto: %u; tot_len=%d\n", prefix,
